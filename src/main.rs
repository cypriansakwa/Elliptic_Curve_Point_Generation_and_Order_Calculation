...
// Function to generate points on the elliptic curve y^2 = x^3 + ax + b mod p
fn generate_points_on_curve(a: i64, b: i64, p: i64) -> Vec<(i64, i64)> {
...
fn find_order(g: (i64, i64), a: i64, p: i64) -> usize {
